...
public class CurrencyConversionBean {
    ...
    public CurrencyConversionBean(Long id, String from, String to, BigDecimal conversionMutiple, BigDecimal quantity, BigDecimal totalCalculatedAmount, int port) {
        this.id = id;
        this.from = from;
        this.to = to;
